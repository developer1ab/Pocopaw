...
Demonstrates a shopping-oriented execution flow from chat request to outcome writeback.
...
- User goal: Complete a shopping-related task through the agent flow.
- Input: A natural-language request in conversation.
- Expected outcome: The task proceeds through preparation and execution with visible result feedback.
...
1. Enter the shopping task request in the conversation view.
...
- Final app behavior: shopping task outcome is visible in conversation and execution surfaces.
